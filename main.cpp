...
int main()
{
    ...
    else
    {
        ...
        customers = {
            ...
            Customer("C003", "Harish", "harish@user.com", "123"),
            Customer("C004", "Isha", "isha@user.com", "123"),
            Customer("C005", "Jaishwal", "jaishwal@user.com", "123")};

        flights = {
            Flight("AI301", "Kanpur", "Kolkata", 8, 1, 20, 4, 2025, 1020, 100),
            Flight("AI302", "Delhi", "Jammu", 11, 2, 21, 4, 2025, 380, 80),
            Flight("AI303", "Delhi", "Ahemdabad", 14, 3, 22, 4, 2025, 1200, 90),
            Flight("AI304", "Jaipur", "Lucknow", 17, 4, 23, 4, 2025, 700, 60),
            Flight("AI305", "Mumbai", "Kolkata", 20, 5, 24, 4, 2025, 1020, 110),
        };
